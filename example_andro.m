...
%%
Num_train = 45;
train_input = andro_array.input(1:Num_train,:);
train_output = andro_array.output(1:Num_train,:);

test_input = andro_array.input(Num_train+1:end,:);
test_output = andro_array.output(Num_train+1:end,:);
...
mean(resi_TGGL.^2)./var(test_output)
mean(resi_RMT.^2)./var(test_output)
